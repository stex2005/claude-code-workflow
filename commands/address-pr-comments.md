---
description: Review and address comments on a PR — accept actionable feedback, explain rejections, with user approval per comment.
allowed-tools: Bash(gh *), Bash(git *), Read, Write, Edit, Glob, Grep
argument-hint: <pr-number>
---

Pull the comments about the PR $ARGUMENTS using `gh pr view $ARGUMENTS --comments`.
